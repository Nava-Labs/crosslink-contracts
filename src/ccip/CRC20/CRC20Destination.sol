 ...
 */
abstract contract CRC20Destination is CRC1, ICRC20Destination, ERC20, FeeAutomation {    
    ...
    constructor(string memory name, string memory symbol, address _router, uint64 _chainIdThis, address _link, address _automationRegistrar) 
        ERC20(name, symbol) 
